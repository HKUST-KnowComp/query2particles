...
class TestDataset(Dataset):
    ...
    @staticmethod
    def collate_fn(data):
        negative_sample = [_[0] for _ in data]
...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        subsampling_weight = (1.0 / subsampling_weight)**0.5
    ...
    def collate_fn(data):
        ...
        negative_sample = [_[1] for _ in data]
        subsample_weight = [_[2] for _ in data]
